 ...
 * @author jon
 */
public class HugeUploadPageSupport extends ToolPageSupport<HuDynamicPageData>
{
  ...
  {
    return huState.isAllowedToParticipate();
  }
  ...
  {
    return huState.isAllowedToManage();
  }
  ...
  @Override
  public HuDynamicPageData makeDynamicPageData()
  {
    return new HuDynamicPageData();
  }
}
