...
import observerassign from "../generated/observerassign.js";
...
function init()
{
  ...
  finder.searchdialogObserveButton.addEventListener( 'click', () => assignObserver() );
 ...
 if ( dynamicData.allowedToConfigure )
  ...
  toolsocket = new observerassign.ToolSocket( dynamicData.webSocketUri, handler  );  
}
...
function openConfig()
{
  ...
  toolsocket.sendMessage( new observerassign.ConfigurationRequestMessage() );
...
function saveConfig()
{
  ...
  toolsocket.sendMessage( new observerassign.ConfigureMessage( updatedconfig ) );
}
