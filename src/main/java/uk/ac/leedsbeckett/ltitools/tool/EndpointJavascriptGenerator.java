...
import uk.ac.leedsbeckett.ltitools.tool.websocket.HandlerMethodRecord;
...
public class EndpointJavascriptGenerator
{
  ...
  public static void main( String[] args )
  {
    ...
    if ( args.length != 1 )
    {
      System.err.println( "Needs directory of webapp source files in parameter." );
      System.exit( 1 );
    }
    ...
    Reflections r = new Reflections( "uk.ac.leedsbeckett" );
