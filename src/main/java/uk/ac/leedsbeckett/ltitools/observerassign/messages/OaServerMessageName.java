 ...
 * @author maber01
 */
public enum OaServerMessageName implements ToolMessageName
{
  /**
   * Message contains a simple alert message for the user.
   */
  Alert(                "Alert",                String.class ),
  Configuration(        "Configuration",        OaConfigurationMessage.class ),
   ...
   */
  OaServerMessageName( String name, Class payloadClass )
  {
    this.name = name;
