...
* /jwks
* /autoreg
* /deeplinking/index.jsp?state_id={uuid string here}
* /peergroupassessment/index.jsp?state_id={uuid string here}
* /selfenrol/index.jsp?state_id={uuid string here}
* /socket/deeplinking?state_id={uuid string here}
* /socket/peergroupassessment?state_id={uuid string here}
* /socket/selfenrol?state_id={uuid string here}
...
a single parameter query string `state_id`. The value of `state_id` is generated by the IMS Login
servlet.
...
URL takes a single parameter query string `state_id`. The value of `state_id` is generated by the IMS Login
servlet. 
