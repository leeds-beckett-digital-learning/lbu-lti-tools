...
const dynamicPageData = ${support.dynamicPageDataAsJSON};
    ...
    <script type="module" src="../javascript/@BUILDTIMESTAMP@/sharepointsub/course.js"></script>
  </head>
  <body>
    ...
    <div class="section">
      ...
      <div class="block">
        ...
        <h2>LBU Sharepoint Submission</h2>
        ...
        <p><button id="adddropboxButton">Add Dropbox</button></p>          
