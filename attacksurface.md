...
a single parameter query string `state`. The value of `state` is generated by the IMS Login
servlet.
...
URL takes a single parameter query string `state`. The value of `state` is generated by the IMS Login
servlet. 
