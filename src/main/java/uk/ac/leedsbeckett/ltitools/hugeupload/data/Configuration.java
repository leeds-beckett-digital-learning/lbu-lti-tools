...
public class Configuration
{
  ...
  private final boolean membershipStudentDeepLinkPermitted;
  ...
  private Configuration( 
          ...
          @JsonProperty( value = "membershipStudentDeepLinkPermitted", required = true ) 
                  boolean membershipStudentDeepLinkPermitted
          )
  {
    this.membershipInstructorDeepLinkPermitted = membershipInstructorDeepLinkPermitted;
    this.membershipStudentDeepLinkPermitted = membershipStudentDeepLinkPermitted;
  }
  ...
  public boolean isMembershipStudentDeepLinkPermitted()
  {
    return membershipStudentDeepLinkPermitted;
  }
