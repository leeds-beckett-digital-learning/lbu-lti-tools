 ...
 * @author maber01
 */
public enum HuServerMessageName implements ToolMessageName
{
  /**
  ...
  BinaryChunkUploadReq( "BinaryChunkUploadReq", HuBinaryChunkUploadRequest.class ),
  
  BinaryChunkDownload( "BinaryChunkDownload",   HuBinaryChunkDownload.class ),
  /**
   ...
   */
  HuServerMessageName( String name, Class payloadClass )
  {
    this.name = name;
